...
public class TestForLevel1 extends Application {
	boolean a = false;
	TestForLevel2 tf2 = new TestForLevel2();
	...
	public void start(Stage stage) {
		...
		circle2.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent t) {
				...
				if (a == false) {
					BooleanBinding intersecting = thickLine3.startXProperty()
							.lessThanOrEqualTo(540-40);
				...
				Timeline anm2 = new Timeline(new KeyFrame(Duration.seconds(1), new KeyValue(sc.lengthProperty(), 94),
				...
				Timeline anm3 = new Timeline(new KeyFrame(Duration.seconds(1), new KeyValue(sc.lengthProperty(), -6),
