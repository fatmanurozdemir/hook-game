...
public class Level2 extends Application {
	...
	boolean b = false;
	boolean c = false;
	// Creating level3 object to pass to Level4 after Level2 finished successfully
	...
	public void start(Stage stage) {
		...
		circle2.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent t) {
				...
				// Shortening thickLine3, sliding thickLine3 and sc1
				Timeline anm1 = new Timeline(new KeyFrame(Duration.seconds(1),
						new KeyValue(thickLine4.startYProperty(), 380), new KeyValue(thickLine3.startYProperty(), 240),
						new KeyValue(thickLine3.endYProperty(), 308), new KeyValue(sc2.centerYProperty(), 344),
						new KeyValue(thickLine1.startYProperty(), 124), new KeyValue(thickLine1.endYProperty(), 168),
						new KeyValue(sc1.centerYProperty(), 204)));
				anm1.play();

				// Checking collision situation of thickLine3 and thickLine2 or thickLine5, if it happens restarting the same level
				if (a == false || c == false) {
					...
					intersecting.addListener((obs, wasIntersecting, isNowIntersecting) -> {
						anm1.stop();
						// Forming same conditions for the beginning of Level2
						a = false;
						b = false;
						c = false;
						start(stage);
				...
				// Sliding thickLine3, thickLine1, sc1 and shortening sc2
				Timeline anm2 = new Timeline(new KeyFrame(Duration.seconds(0.5),
						new KeyValue(thickLine3.startYProperty(), 278), new KeyValue(thickLine3.endYProperty(), 346),
						new KeyValue(sc2.centerYProperty(), 382), new KeyValue(sc2.lengthProperty(), 90),
						new KeyValue(thickLine1.startYProperty(), 162), new KeyValue(thickLine1.endYProperty(), 206),
						new KeyValue(sc1.centerYProperty(), 242)));
				
				Timeline anm3 = new Timeline(new KeyFrame(Duration.seconds(0.5),
						new KeyValue(thickLine3.startYProperty(), 316), new KeyValue(thickLine3.endYProperty(), 380),
						new KeyValue(sc2.centerYProperty(), 420), new KeyValue(sc2.lengthProperty(), 0),
						new KeyValue(thickLine1.startYProperty(), 200), new KeyValue(thickLine1.endYProperty(), 244),
						new KeyValue(sc1.centerYProperty(), 280)));

				// Sliding thickLine1 and sc1 and shortening thickLine3
				Timeline anm4 = new Timeline(new KeyFrame(Duration.seconds(1),
						new KeyValue(thickLine3.startYProperty(), 380), new KeyValue(thickLine1.startYProperty(), 262),
						new KeyValue(thickLine1.endYProperty(), 306), new KeyValue(sc1.centerYProperty(), 344)));

				// Sliding thickLine1 and shortening sc1
				Timeline anm5 = new Timeline(new KeyFrame(Duration.seconds(0.5),
						new KeyValue(thickLine1.startYProperty(), 300), new KeyValue(thickLine1.endYProperty(), 344),
						new KeyValue(sc1.centerYProperty(), 380), new KeyValue(sc1.lengthProperty(), -90)));
				
				Timeline anm6 = new Timeline(new KeyFrame(Duration.seconds(0.5),
						new KeyValue(thickLine1.startYProperty(), 336), new KeyValue(thickLine1.endYProperty(), 380),
						new KeyValue(sc1.centerYProperty(), 418), new KeyValue(sc1.lengthProperty(), 0)));
				
				//Shortening thickLine1
				Timeline anm7 = new Timeline(new KeyFrame(Duration.seconds(1),
						new KeyValue(thickLine1.startYProperty(), 380), new KeyValue(thickLine1.endYProperty(), 380)));
				...
				//Starting Level3 if Level2 is completed successfully
		...
		circle3.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent t) {
				...
				// Eliminating the possibility of a collision thickLine6 can cause
				b = true;
		...
		circle4.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent t) {
				...
				// Sliding thickLine5 and sc3, shortening thickLine7
				Timeline anm1 = new Timeline(new KeyFrame(Duration.seconds(1),
				...
				// Eliminating the possibility of a collision thickLine5 can cause
				c = true;

				// Checking collision situation of thickLine5 and thickLine6, if it happens restarting the same level
				if (b == false) {
				...
				// Sliding thickLine5 and shortening sc3
				Timeline anm2 = new Timeline(new KeyFrame(Duration.seconds(0.5), new KeyValue(sc3.lengthProperty(), -90),
						new KeyValue(sc3.centerXProperty(), 680), new KeyValue(thickLine5.startXProperty(), 504),
						new KeyValue(thickLine5.endXProperty(), 646)));

				Timeline anm3 = new Timeline(new KeyFrame(Duration.seconds(0.5), new KeyValue(sc3.lengthProperty(), 6),
						new KeyValue(sc3.centerXProperty(), 718), new KeyValue(thickLine5.startXProperty(), 542),
						new KeyValue(thickLine5.endXProperty(), 680)));

				//Shortening thickLine5
				Timeline anm4 = new Timeline(new KeyFrame(Duration.seconds(1),
